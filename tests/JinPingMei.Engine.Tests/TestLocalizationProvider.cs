...
internal sealed class TestLocalizationProvider : ILocalizationProvider
{
    ...
    public TestLocalizationProvider()
    {
        var zhTw = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["commands.look.header"] = "您身處於：{0}",
            ["commands.look.locale"] = "所屬地區：{0} —— {1}",
            ["commands.look.npcs"] = "在場角色：{0}。",
            ["commands.look.no_npcs"] = "此處暫無角色停留。",
            ["commands.look.exits"] = "可前往：{0}。",
            ["commands.look.no_exits"] = "此處暫無明顯出路。",
            ["commands.go.prompt"] = "請以 /go <地點> 的格式輸入要前往的位置。",
            ["commands.go.unknown"] = "無法辨識該去處。",
            ["commands.go.transition"] = "你朝著{0}前行，抵達了{1}。",
            ["commands.examine.prompt"] = "請輸入 /examine scene 或角色名稱進行觀察。",
            ["commands.examine.scene"] = "你仔細端詳{0}。",
            ["commands.examine.paths"] = "可通往的路徑：",
            ["commands.examine.path_detail"] = "．{0} —— {1}",
